...
export HISTFILE=/work/.devcontainer/.bash_history
alias ansible-pg='ansible -i /work/.config/inventory/hosts.playground.yml'
alias ansible-pp='ansible-playbook -i /work/.config/inventory/hosts.playground.yml'
alias ap='ansible-playbook'
alias app='ansible-playground-playbook'
